...
- [x] 2.8 Fail closed on incomplete legacy locks, preserve the v1 cursor boundary across tied timestamps, and separate Plant durable state and Agent Run receipt ownership
