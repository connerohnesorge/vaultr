...
- [x] 1.1 Expose Reconstruction's retained sealed-to-detached-to-live-raw traversal, including committed-suffix digest proof, as a closure-based streaming Envelope seam and use it from `coverage(vault, sid)`
...
- [x] 3.4 Unit test: mixed sealed/detached/raw generations entered through any canonical sibling preserve detached evidence unless the retained sealed suffix proves it committed, tolerate only the live tail, and report fixture gaps
